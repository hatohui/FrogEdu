...
RUN dotnet restore Content.API/FrogEdu.Content.API.csproj
...
ENTRYPOINT ["dotnet", "watch", "run", "--project", "Content.API/FrogEdu.Content.API.csproj", "--urls", "http://0.0.0.0:8080"]
