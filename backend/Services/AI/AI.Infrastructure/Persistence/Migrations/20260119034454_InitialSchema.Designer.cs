...
namespace FrogEdu.AI.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260119034454_InitialSchema")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FrogEdu.AI.Domain.Entities.ConversationMessage", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("FrogEdu.AI.Domain.Entities.PromptTemplate", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("FrogEdu.AI.Domain.Entities.SessionArtifact", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("FrogEdu.AI.Domain.Entities.SessionEvent", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("FrogEdu.AI.Domain.Entities.TutorSession", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("FrogEdu.AI.Domain.Entities.ConversationMessage", b =>
                {
                    b.HasOne("FrogEdu.AI.Domain.Entities.TutorSession", "TutorSession")
                        .WithMany("Messages")
